...
void GlShaderProgram::setNVectorAttribute(std::string &attributeName, GLsizei stride, const GLvoid* data, int dimension) {
    ...
    glVertexAttribPointer( attribId, dimension, GL_FLOAT, GL_FALSE, stride, data );
}
