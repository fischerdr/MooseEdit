...
//compile error GRANNY_DYNLINK(granny_blend_dag_leaf_callback_sample_callback *) GrannyGetBlendDagNodeCallbackSampleCallback(granny_blend_dag_node * Node);
//compile error GRANNY_DYNLINK(granny_blend_dag_leaf_callback_set_clock_callback *) GrannyGetBlendDagNodeCallbackSetClockCallback(granny_blend_dag_node * Node);
//compile error GRANNY_DYNLINK(granny_blend_dag_leaf_callback_motion_vectors_callback *) GrannyGetBlendDagNodeCallbackMotionVectorsCallback(granny_blend_dag_node * Node);
...
//compile error GRANNY_DYNLINK(granny_open_file_reader_callback *) GrannyGetDefaultFileReaderOpenCallback(void);
...
GRANNY_DYNLINK(granny_file_writer *) GrannyCreatePlatformFileWriter(char const * SourceFileName,
                                                                    ...
                                                                    char const * FileNameToOpen,
                                                                    bool EraseExisting);
//compile error GRANNY_DYNLINK(granny_open_file_writer_callback *) GrannyGetDefaultFileWriterOpenCallback(void);
...
//compile error GRANNY_DYNLINK(granny_thread_id_callback *) GrannySetThreadIDCallback(granny_thread_id_callback * Callback);
...
GRANNY_DYNLINK(void) GrannySampleTrackUUULocalAtTime0(granny_transform_track const * SourceTrack,
                                                      granny_transform * Result);
//compile error GRANNY_DYNLINK(granny_track_sampler *) GrannyGetTrackSamplerFor(granny_transform_track const * Track);
//compile error GRANNY_DYNLINK(granny_track_sampler *) GrannyGetTrackSamplerUUU(void);
//compile error GRANNY_DYNLINK(granny_track_sampler *) GrannyGetTrackSamplerSSS(void);
//compile error GRANNY_DYNLINK(granny_track_sampler *) GrannyGetTrackSamplerIII(void);
//compile error GRANNY_DYNLINK(granny_track_sampler *) GrannyGetTrackSamplerIIU(void);
